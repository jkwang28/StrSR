...
IMAGE_DESCRIPTION_PROMPT = "Descibe this image in detail, especially the text in image. Cinematic, hyper sharpness, highly detailed, perfect without deformations. Camera, hyper detailed photo, realistic maximum detail, 32k, Color. Grading, ultra HD, extreme meticulous detailing, skin pore detailing"
